 ...
 */
public class AnotacionPostal implements Serializable {
    private int mId = -1;
    ...
    public AnotacionPostal() {

    }
    public AnotacionPostal(int id, String color, String title, int locationX, int locationY) {
        mId = id;
        mColor = color;
        mTitle = title;
